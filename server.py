...
questions = [
    ...
    {
        "question": "Which famous landmark is known as one of the 'New 7 Wonders'?",
        "options": ["The Rock-Hewn Churches of Lalibela", "The Pyramids of Axum", "The Great Wall of Harar", "Simien Mountains"],
